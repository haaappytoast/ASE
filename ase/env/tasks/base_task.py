...
class BaseTask():
    ...
    def __init__(self, cfg, enable_camera_sensors=False):
        ...
        self.num_states = 0                                                                         #! TODO: remove

        #! set sim's variable(physx engine)
        ...
        self.states_buf = torch.zeros(
            (self.num_envs, self.num_states), device=self.device, dtype=torch.float)                #! TODO: remove
    ...
    #! TODO: delete when deepmimic model constructed
    def get_states(self):
