...
class testHumanoid(Humanoid):
    ...
    def post_physics_step(self):
        ...
        body_pos1 = self._rigid_body_pos
        body_rot1 = self._rigid_body_rot
        body_vel1 = self._rigid_body_vel
        body_ang_vel1 = self._rigid_body_ang_vel
        ...
        # pos = rigid_body_state[1]['pose']['p']
        # rot = rigid_body_state[idx]['pose']['r']
        ...
        ref_rot, ref_ang_vel = self._motion_lib.get_motion_body_state(motion_ids, motion_times)
